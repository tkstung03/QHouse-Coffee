  ...
  // Lấy thông tin từ bảng đồ uống qua trang sửa danh mục
   $(document).ready(function () {
    ...
    $("#btn_them_douong").click(function(){
      $("#douong").hide();
      $("#themdouong").show();
      var lastMaDoUong = $("#table_douong tbody tr:last-child td:nth-child(2)").text();
      var newMaDoUong = "DU" + String(parseInt(lastMaDoUong.substr(2)) + 1).padStart(3, "0");
    ...
    $("#btn_luu_douong").click(function(){
      ...
      var giabanFormatted = giaban.toLocaleString('it-IT', {style: 'currency', currency: 'VND'});   
      var lastSTT = $("#table_douong tbody tr:last-child td:nth-child(1)").text();
      var newSTT = String(parseInt(lastSTT) + 1);
      var newMa = $("#madouongmoi").text();
      var newRow = $('<tr><td>' + newSTT + '</td><td>' + newMa + '</td><td>' + tendouong + '</td><td>' + giabanFormatted + '</td>');
      var editButton = $("<button></button>").addClass("btn pt-0 m-0 list-inline-item");
      var editIcon = $("<span></span>").addClass("fas fa-edit");
      editButton.append(editIcon);
      var deleteButton = $("<button></button>").addClass("btn pt-0 m-0 list-inline-item");
    ...
    $(document).on("click", ".tuychon_douong .fa-edit", function() {
      ...
      $("#btn_luu_douong_sua").click(function(){
        ...
        var giaBanSauSuaFormatted = giaBanSauSua.toLocaleString('it-IT', {style: 'currency', currency: 'VND'});
    ...
    $(document).ready(function() {
      $("#tuychonhoadon").change(function() {
        ...
        if (selectedOption === "Tất cả") {
          ...
          $("#table_hoadon tbody tr").hide().filter(function() {
    ...
    $("#btn_them_nguyenlieu").click(function(){
      ...
      var newManguyenlieu = "DU" + String(parseInt(lastManguyenlieu.substr(2)) + 1).padStart(3, "0");
    ...
    $("#btn_luu_nguyenlieu").click(function(){
      ...
      var lastSTT = $("#table_nguyenlieu tbody tr:last-child td:nth-child(1)").text();
      var newSTT = String(parseInt(lastSTT) + 1);
      var newMa = $("#manguyenlieumoi").text();
      var newRow = $('<tr><td>' + newSTT + '</td><td>' + newMa + '</td><td>' + tennguyenlieu + '</td><td>' + giabanFormatted + '</td><td>' + soluong + '</td>');
      var editButton = $("<button></button>").addClass("btn pt-0 m-0 list-inline-item");
      var editIcon = $("<span></span>").addClass("fas fa-edit");
      editButton.append(editIcon);
      var deleteButton = $("<button></button>").addClass("btn pt-0 m-0 list-inline-item");
    ...
    $(document).on("click", ".tuychon_nguyenlieu .fa-edit", function() {
      ...
      $("#btn_luu_nguyenlieu_sua").click(function(){
        ...
        var giaNhapSauSuaFormatted = giaNhapSauSua.toLocaleString('it-IT', {style: 'currency', currency: 'VND'});
    ...
    $("#btn_them_nhanvien").click(function(){
      ...
      var newManhanvien = "DU" + String(parseInt(lastManhanvien.substr(2)) + 1).padStart(3, "0");
    ...
    $("#btn_luu_nhanvien").click(function(){
      ...
      var mucluongFormatted = mucluong.toLocaleString('it-IT', {style: 'currency', currency: 'VND'});   
      var soluong = parseInt($("#soluongmoi").val());
      var lastSTT = $("#table_quanlynhanvien tbody tr:last-child td:nth-child(1)").text();
      var newSTT = String(parseInt(lastSTT) + 1);
      var newMa = $("#manhanvienmoi").text();
      var newRow = $('<tr><td>' + newSTT + '</td><td>' + newMa + '</td><td>' + tennhanvien + '</td><td>' + mucluongFormatted + '</td><td>' + soluong + '</td>');
      var editButton = $("<button></button>").addClass("btn pt-0 m-0 list-inline-item");
      var editIcon = $("<span></span>").addClass("fas fa-edit");
      editButton.append(editIcon);
      var deleteButton = $("<button></button>").addClass("btn pt-0 m-0 list-inline-item");
    ...
    $(document).on("click", ".tuychon_quanlynhanvien .fa-edit", function() {
      ...
      $("#btn_luu_nhanvien_sua").click(function(){
        ...
        var mucluongSau = parseInt(parseInt($("#songaycongsua").val()) * 300000 + parseInt($("#sogiotangcasua").val()) * 30000); 
        var mucluongSauFormatted = mucluongSau.toLocaleString('it-IT', {style : 'currency', currency : 'VND'});
        row.find(".mucluong").text(mucluongSauFormatted);

        var tongluongSau = parseInt(mucluongSau) - parseInt($("#thuongsua").val()) + parseInt($("#phatsua").val());
        var tongluongSauFormatted = tongluongSau.toLocaleString('it-IT', {style : 'currency', currency : 'VND'});
        row.find(".tongluong").text(tongluongSauFormatted);

        var thuongSauSua = parseInt($("#thuongsua").val());
        var thuongSauSuaFormatted = thuongSauSua.toLocaleString('it-IT', {style: 'currency', currency: 'VND'});
        row.find(".thuongSauSua").text(thuongSauSuaFormatted);

        var phatSauSua = parseInt($("#phatsua").val());
        var phatSauSuaFormatted = phatSauSua.toLocaleString('it-IT', {style: 'currency', currency: 'VND'});
